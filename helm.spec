...
Requires:      golang(k8s.io/api/apps/v1)
...
Requires:      golang(k8s.io/apimachinery/pkg/api/equality)
...
Requires:      golang(k8s.io/helm/pkg/manifest)
...
Requires:      golang(k8s.io/helm/pkg/renderutil)
...
Requires:      golang(k8s.io/helm/pkg/storage/errors)
Requires:      golang(k8s.io/helm/pkg/strvals)
Requires:      golang(k8s.io/helm/pkg/sympath)
...
Requires:      golang(k8s.io/kubernetes/pkg/api/legacyscheme)
Requires:      golang(k8s.io/kubernetes/pkg/api/v1/pod)
Requires:      golang(k8s.io/kubernetes/pkg/apis/batch)
Requires:      golang(k8s.io/kubernetes/pkg/apis/core)
Requires:      golang(k8s.io/kubernetes/pkg/apis/core/v1/helper)
...
Requires:      golang(k8s.io/kubernetes/pkg/kubectl/cmd/get)
Requires:      golang(k8s.io/kubernetes/pkg/kubectl/cmd/util)
Requires:      golang(k8s.io/kubernetes/pkg/kubectl/genericclioptions)
Requires:      golang(k8s.io/kubernetes/pkg/kubectl/genericclioptions/resource)
